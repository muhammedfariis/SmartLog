        ...
        >
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            <div className="relative">
              <User
                className={`absolute left-4 top-1/2 -translate-y-1/2 size-5 transition-colors ${focused === "user" ? "text-violet-400" : "text-zinc-600"}`}
              />
              <input
            ...
            <div className="relative">
              <Lock
                className={`absolute left-4 top-1/2 -translate-y-1/2 size-5 transition-colors ${focused === "pass" ? "text-violet-400" : "text-zinc-600"}`}
              />
              <input
