      ...
      <div className="space-y-5">
        <div className="bg-black border border-violet-500 rounded-2xl p-5 shadow space-y-4">
          ...
          <div className="grid sm:grid-cols-2 gap-3 text-gray-300">
            <p>
              <span className="text-gray-500">Route:</span> Kochi → Trivandrum
            </p>
            <p>
              <span className="text-gray-500">Vehicle:</span> KL-07-AB-1234
            </p>
            <p>
              <span className="text-gray-500">Load:</span> Electronics
            </p>
          </div>

          <button
            className="w-full md:w-48 py-2 rounded-xl font-medium bg-violet-600 hover:bg-violet-700"
        ...
        {stop && (
          <div className="bg-black border border-violet-500 rounded-2xl p-5 shadow space-y-4 opacity-90">
            ...
            <button
              className="w-full md:w-48 py-2 rounded-xl font-medium bg-red-600 hover:bg-red-700"
        ...
        {returning && (
          <div className="bg-black border border-violet-500 rounded-2xl p-5 shadow space-y-4">
            <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-2">
              <h2 className="text-lg font-semibold text-white">Return Trip</h2>
            ...
            <div className="grid sm:grid-cols-2 gap-3 text-gray-300">
              <p>
                <span className="text-gray-500">Route:</span> Trivandrum → Kochi
              </p>
              <p>
                <span className="text-gray-500">Vehicle:</span> KL-07-AB-1234
              </p>
